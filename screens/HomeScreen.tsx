    ...
    <View style={styles.container}>
        <ScrollView style={styles.container}>
          ...
          <View style={styles.container_progreso}>
            ...
            <Text style={styles.text_progreso}>Realiza el 100% de los test para obtener el resultado final</Text>
          ...
          <View style={styles.test_personalidad}>
            ...
            <View style={styles.contenedor_text}>
              ...
              <Text style={styles.text_personalidad}>Toma menos de 12 minutos.</Text>
          ...
          <View style={styles.test_personalidad}>
            ...
            <View style={styles.contenedor_text}>
              ...
              <Text style={styles.text_psicotecnico}>Comprueba por ti mismo las aptitudes que tienes para resolver este tipo de pruebas</Text>
            </View>
          </View>
          ...
          <View style={styles.test_personalidad}>
            ...
            <View style={styles.contenedor_text}>
              ...
              <Text style={styles.text_entrevista}>Agenda una entrevista con un profesional capacitado</Text>
            </View>
          </View>
        </ScrollView>
    </View>
