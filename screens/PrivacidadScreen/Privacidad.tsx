    ...
    <ScrollView style={{ width: "100%", backgroundColor: "#130C34",}}>
      <View style={{ width: "100%", backgroundColor: "#130C34",  alignItems:"center"}}>
        ...
        >
          ...
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Legalidad:</Text> Sólo recopilaremos sus Datos personales para fines específicos, explícitos y legítimos.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Minimización de datos:</Text>  Limitamos la recogida de datos de carácter personal a lo que es estrictamente relevante y necesario para los fines para los que se han recopilado.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Limitación de la Finalidad: </Text>Sólo recogeremos sus datos personales para los fines declarados y sólo según sus deseos</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Precisión:</Text>antendremos sus datos personales exactos y actualizados.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Seguridad de los Datos: </Text>Aplicamos las medidas técnicas y organizativas adecuadas y proporcionales a los riesgos para garantizar que sus datos no sufran daños, tales como divulgación o acceso no autorizado, la destrucción accidental o ilícita o su pérdida accidental o alteración y cualquier otra forma de tratamiento ilícito.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Conservación:</Text>Conservamos sus datos personales de manera legal y apropiada y sólo mientras es necesario para los fines para los que se han recopilado.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Terceros:</Text> El acceso y transferencia de datos personales a terceros se llevan a cabo de acuerdo con las leyes y reglamentos aplicables y con las garantías contractuales adecuadas.</Text>
          <Text style={styles.text_test}><Text style={styles.tov_s_a}>• Marketing Directo y cookies:</Text>Cumplimos con la legislación aplicable en materia de publicidad y cookies.</Text>
          ...
          <Text style={styles.text_test}>• Datos de carácter identificativo.</Text>
          ...
          <Text style={styles.text_test}>• Nos ha dado su consentimiento a los efectos del tratamiento. Por supuesto podrá retirar su consentimiento en cualquier momento.</Text>
          <Text style={styles.text_test}>• Por requerimiento legal.</Text>
          <Text style={styles.text_test}>• Por existir un interés legítimo que no se vea menoscabado por sus derechos de privacidad, como por ejemplo el envío de información comercial bien por suscripción a nuestra newsletter o por su condición de cliente.</Text>
          <Text style={styles.text_test}>• Por ser necesaria para la prestación de alguno de nuestros servicios mediante relación contractual entre usted y nosotros.</Text>
          ...
          <Text style={styles.text_test}>• Acceder a sus datos personales y a cualquier otra información indicada en el Artículo 15.1 del RGPD.</Text>
          <Text style={styles.text_test}>• Rectificar sus datos personales que sean inexactos o estén incompletos de acuerdo con el Artículo 16 del RGPD.</Text>
          <Text style={styles.text_test}>• Suprimir sus datos personales de acuerdo con el Artículo 17 del RGPD.</Text>
          <Text style={styles.text_test}>• Limitar el tratamiento de sus datos personales de acuerdo con el Artículo 18 del RGPD.</Text>
          <Text style={styles.text_test}>• Solicitar la portabilidad de sus datos de acuerdo con el Artículo 20 del RGPD.</Text>
          <Text style={styles.text_test}>• Oponerse al tratamiento de sus datos personales de acuerdo con el artículo 21 del RGPD.</Text>
